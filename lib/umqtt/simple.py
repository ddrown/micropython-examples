# from micropython: https://github.com/micropython/micropython-lib/tree/master/micropython/umqtt.simple/umqtt
...
class MQTTClient:
    ...
    def connect(self, clean_session=True, timeout=None):
        ...
        writebuffer = premsg[0:i+2]
        writebuffer = writebuffer + msg
        # print(hex(len(msg)), hexlify(msg, ":"))
        self.sock.send(writebuffer)
